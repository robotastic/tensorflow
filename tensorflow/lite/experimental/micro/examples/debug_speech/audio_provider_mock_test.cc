...
#include "tensorflow/lite/experimental/micro/examples/debug_speech/no_1000ms_sample_data.h"
#include "tensorflow/lite/experimental/micro/examples/debug_speech/yes_1000ms_sample_data.h"
